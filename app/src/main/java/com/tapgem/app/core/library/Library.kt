...
object Library {
    ...
    private fun prettify(base: String) = when (base) {
        "tutor_client" -> "Language Tutor"          // "Tutor" alone said nothing about what it tutors
        else -> base.removeSuffix("_client").removeSuffix("_app").split('_').filter { it.isNotBlank() }
